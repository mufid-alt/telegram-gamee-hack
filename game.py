...
-h, --help           help menu tere liye sirf          False
-u, --url            game ka link daal vro             None
-t, --time           game run time                     Random
-s, --score   	     tera score                        None

	--get-rank       teri rank dikhegi             False
	--get-record     tera score dikhega            False
	--get-summery    profile name wagerah wagerah  False
    --get-name       game ka naam                  False 
